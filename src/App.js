...
// industry slide metrics are now imported from ./data/constants
...
// case studies data moved to ./data/constants
...
// Use cases view moved to external page component at src/pages/UseCasesPage.js

// `IndustryPage` is provided as a separate file at `src/pages/IndustryPage.js`.

// `IndustryPage` is provided as a separate file at `src/pages/IndustryPage.js`.

// Admin dashboard UI moved to src/pages/AdminHub.js and related admin pages.
